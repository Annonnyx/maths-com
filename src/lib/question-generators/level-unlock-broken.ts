...
// Seuils de déblocage pour chaque niveau (basé sur les ELO_LEVEL_RANGES)
const LEVEL_UNLOCK_AT_ELO: Record<SchoolLevel, number> = {
  'CP': 0,
  'CE1': ELO_LEVEL_RANGES.CE1.min,
  'CE2': ELO_LEVEL_RANGES.CE2.min,
  'CM1': ELO_LEVEL_RANGES.CM1.min,
  'CM2': ELO_LEVEL_RANGES.CM2.min,
  '6e': ELO_LEVEL_RANGES['6e'].min,
  '5e': ELO_LEVEL_RANGES['5e'].min,
  '4e': ELO_LEVEL_RANGES['4e'].min,
  '3e': ELO_LEVEL_RANGES['3e'].min,
  '2de': ELO_LEVEL_RANGES['2de'].min,
  '1re': ELO_LEVEL_RANGES['1re'].min,
  'Tle': ELO_LEVEL_RANGES['Tle'].min,
  'Sup1': ELO_LEVEL_RANGES.Sup1.min,
  'Sup2': ELO_LEVEL_RANGES.Sup2.min,
  'Sup3': ELO_LEVEL_RANGES.Sup3.min,
  'Pro': ELO_LEVEL_RANGES.Pro.min
};
