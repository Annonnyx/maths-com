...
export const config = {
  matcher: [
    '/((?!api/auth|api/users|api/cli|api/debug|api/leaderboard/public|api/tickets|api/discord|_next/static|_next/image|favicon.ico|robots.txt|login|register|cgu|confidentialite|cookies|mentions-legales|mineurs|transferts-donnees|/).*)'
  ]
}
