-- Corrected verification that adapts to actual table structure
...
-- 2. Sample data from questions table (without created_at)
SELECT 
    question,
    answer,
    type,
...
-- 4. Sample multiplayer questions (without created_at)
SELECT 
    question,
    answer,
    type,
