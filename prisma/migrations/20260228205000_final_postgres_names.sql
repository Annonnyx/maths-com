-- Migration finale : Créer les tables avec noms Prisma puis RLS avec noms PostgreSQL
-- Étape 1: Créer les tables avec la structure exacte de Prisma (noms camelCase)
-- Étape 2: Activer RLS
-- Étape 3: Créer les politiques RLS avec les vrais noms de colonnes PostgreSQL (snake_case)

-- Créer l'extension UUID
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Créer les tables avec la structure exacte de Prisma (noms camelCase)
...
-- Étape 3: Créer les politiques RLS avec les vrais noms PostgreSQL (snake_case)
-- Note: PostgreSQL transforme automatiquement les noms camelCase en snake_case
-- Donc userId devient user_id, hostId devient host_id, etc.
