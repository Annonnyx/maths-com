        ...
        try {
            ...
            if (result.valid) {
                ...
                const successEmbed = new EmbedBuilder()
                    ...
                    .addFields({ name: 'Utilisateur Discord', value: message.author.username, inline: true }, { name: 'ID Discord', value: message.author.id, inline: true }, { name: 'Statut', value: '✅ Vérifié', inline: true })
                    .setFooter({
                ...
                const errorEmbed = new EmbedBuilder()
                    ...
                    .addFields({ name: 'Raison possible', value: '• Code expiré (10 minutes)\n• Code déjà utilisé\n• Code incorrect' })
                    .setFooter({
